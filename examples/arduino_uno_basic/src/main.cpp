/**
 * Arduino Uno - L298N Motor Driver Basic Example
 * 
 * This example demonstrates basic motor control using the L298N motor driver
 * with an Arduino Uno. It shows forward, backward, braking, and coasting.
 * 
 ...
 * - Connect GND of power supply to L298N GND and Arduino GND
 * - If using 12V, remove the 5V jumper on L298N and connect 5V pin to Arduino 5V
 */
...
void setup() {
  Serial.begin(9600);
  Serial.println("L298N Motor Driver Test - Arduino Uno");
  Serial.println("=====================================");
